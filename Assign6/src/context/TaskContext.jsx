...
/**
 * TaskContext
 * Manages full CRUD operations for tasks:
 * - Each task has: id, title, description, priority, category, due, status
 * - Methods: createTask, updateTask, deleteTask, toggleComplete
 */
...
export const TaskProvider = ({ children }) => {
  ...
  // Toggle Completed vs Pending status
